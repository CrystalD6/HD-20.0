...
public class GrimoireScreen extends Screen {
    ...
    private static final int C_BG       = 0xEE060615;
    private static final int C_BORDER   = 0xFF3A6FFF;
    private static final int C_TITLE    = 0xFFD4AF37;
    private static final int C_SEL      = 0xFF162250;
    private static final int C_PASSIVE  = 0xFF7EC8E3;
    private static final int C_ACTIVE   = 0xFFFFD700;
    private static final int C_ULTIMATE = 0xFFFF6030;
    private static final int C_BIND     = 0xFF90EE90;
    ...
    public boolean keyPressed(int key, int scan, int mods) {
        ...
        if (key == 265 && selectedIdx > 0) {
            selectedIdx--;
            if (selectedIdx < scroll) scroll--;
            return true;
        }
    ...
    public void render(GuiGraphics ctx, int mx, int my, float delta) {
        ...
        int divX = x + W / 2;
        ctx.fill(divX, y + 2, divX + 1, y + H - 2, 0xFF1A2A55);
    ...
    private int typeColor(String t) {
        return switch (t.toLowerCase()) {
            case "passive"  -> C_PASSIVE;
            case "active"   -> C_ACTIVE;
            case "ultimate" -> C_ULTIMATE;
            default         -> 0xFFFFFFFF;
        };
    }
